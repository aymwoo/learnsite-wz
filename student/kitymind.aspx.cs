...
public partial class student_kitymind : System.Web.UI.Page
{
    protected string Id = "";
        ...
        if (LearnSite.Common.WordProcess.IsNum(Lid))
        {
            ...
            if (model != null)
            {
                ...
                else
                {
                    ...
                    {
                        string xmlstr = LearnSite.Common.XmlHelp.ReadJsonFile(examurl);
                        codefile = HttpUtility.UrlEncode(xmlstr) ;
                    }
                }
