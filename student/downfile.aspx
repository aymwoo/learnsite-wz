<%@ page title="" language="C#" masterpagefile="~/student/Stud.master" stylesheettheme="Student" autoeventwireup="true" inherits="Student_downfile, App_Web_vamzechw" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Cphs" runat="Server">
    <script type="text/javascript">
        function accessResource(fid) {
            var xhr = new XMLHttpRequest();
            xhr.open('POST', '../api/ResourceProxy.ashx?action=geturl&fid=' + fid, true);
