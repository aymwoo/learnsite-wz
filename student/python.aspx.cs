...
public partial class Student_python : System.Web.UI.Page
{
    protected string Id = " ";
    ...
    protected string MidurlFull = "../images/none.gif ";
            ...
            if (Request.QueryString["lid"] != null)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (Request.Cookies[LearnSite.Common.CookieHelp.stuCookieNname] != null)
                    {
                        ...
                        this.Page.Title = HttpUtility.UrlDecode(stuName) + " Python在线编程";
                    }
                }
            }
        }
        ...
        if (LearnSite.Common.WordProcess.IsNum(Lid))
        {
            ...
            if (model != null)
            {
                ...
                if (jmodel != null)
                {
                    ...
                    MidurlFull = Midurl.Replace("resimg", "fullcover");
                }
            }
        }
    }
