...
<div class="w-full max-w-6xl mx-auto space-y-6">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6 sm:p-10 text-center">
        <h2 class="text-3xl font-extrabold text-slate-800 mb-6 flex items-center justify-center gap-3">
            <span class="text-4xl">👑</span> 中文输入英雄榜
        </h2>
        ...
        <div class="overflow-x-auto bg-white rounded-xl border border-slate-200">
            <asp:GridView ID="GVTyper" runat="server" AutoGenerateColumns="False" CellPadding="0" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Ptid" HeaderText="文章">
                        ...
                        <ItemStyle HorizontalAlign="Left" CssClass="py-2.5 font-medium" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="Ptype" HeaderText="次数">
                        <HeaderStyle HorizontalAlign="Left" CssClass="bg-slate-50 font-semibold px-4 py-3" />
                        <ItemStyle HorizontalAlign="Left" CssClass="py-2.5 font-medium text-slate-500 text-center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Pip" HeaderText=" IP ">
                        <HeaderStyle HorizontalAlign="Left" CssClass="bg-slate-50 font-semibold px-4 py-3 hidden md:table-cell" />
                        <ItemStyle HorizontalAlign="Left" CssClass="py-2.5 text-xs text-slate-400 font-mono hidden md:table-cell" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Pdate" HeaderText="日期">
                        ...
                        <ItemStyle Width="120px" HorizontalAlign="Left" CssClass="py-2.5 text-xs text-slate-400 hidden sm:table-cell" />
                    </asp:BoundField>
                </Columns>
                <PagerTemplate>
        ...
        <div class="mt-8">
            <asp:HyperLink ID="HLtyperank" runat="server" NavigateUrl="~/student/typerank.aspx" 
                Target="_blank" CssClass="inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-orange-400 to-red-500 text-white font-bold text-lg rounded-xl shadow-lg hover:from-orange-500 hover:to-red-600 transition-all transform hover:scale-105">
                ⚔️ 打字擂台榜
            </asp:HyperLink>
        </div>
    </div>
