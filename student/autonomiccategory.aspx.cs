...
public partial class Student_autonomiccategory : System.Web.UI.Page
{
    ...
    {
        aurl = "~/student/download.aspx?id=" + LearnSite.Common.EnDeCode.Encrypt(aurl+"&True","ls");
        return aurl;
    }
    ...
    {
        string urlfat = "../student/download.aspx?id=" + LearnSite.Common.EnDeCode.Encrypt(url+"&True","ls");
        return urlfat;
    }
}