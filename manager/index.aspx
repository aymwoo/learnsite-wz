...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    <style type="text/css">
        ...
        .mgr-hero { position: relative; overflow: hidden; border: 1px solid var(--ls-border); border-radius: 1rem; padding: 24px 28px; background: radial-gradient(circle at top left,rgba(99,102,241,.18),transparent 38%), radial-gradient(circle at right center,rgba(139,92,246,.16),transparent 26%), linear-gradient(135deg,#312e81 0%,#4f46e5 52%,#818cf8 100%); color: #eef2ff; box-shadow: 0 20px 40px rgba(99,102,241,.15); }
