...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    <style type="text/css">
        ...
        .mgr-shell { display: flex; flex-direction: column; gap: 20px; max-width: 600px; margin: 0 auto; }
        .mgr-hero { border: 1px solid var(--ls-border); border-radius: 1rem; padding: 24px 28px; background: linear-gradient(135deg,#0f172a 0%,#1d4ed8 52%,#38bdf8 100%); color: #eff6ff; box-shadow: 0 20px 40px rgba(37,99,235,.15); }
    ...
    <div class="mgr-page">
        <div class="mgr-shell">
            <div class="mgr-hero">
                <h1 class="mgr-hero__title"><i class="bi bi-pencil-square" style="color:#93c5fd;"></i> 修改教师</h1>
            </div>
            <div class="mgr-card">
                <div class="mgr-card__head"><h2 class="mgr-card__title">教师信息</h2></div>
                <div class="mgr-card__body">
                    <div class="mgr-field">
                        <span class="mgr-label">姓名</span>
                    ...
                    <div class="mgr-actions">
                        <asp:Button ID="Btnedit" runat="server" Text="保存修改" onclick="Btnedit_Click" CssClass="mgr-btn mgr-btn--primary" />
