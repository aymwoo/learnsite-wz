...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    <style type="text/css">
        ...
        .mgr-hero { border: 1px solid var(--ls-border); border-radius: 1rem; padding: 24px 28px; background: radial-gradient(circle at top left,rgba(59,130,246,.18),transparent 38%), linear-gradient(135deg,#0f172a 0%,#1d4ed8 52%,#38bdf8 100%); color: #eff6ff; box-shadow: 0 20px 40px rgba(37,99,235,.15); }
