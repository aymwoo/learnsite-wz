...
<body class="bg-pattern min-h-screen flex flex-col font-sans text-gray-800">
    <form id="form1" runat="server" class="flex-grow flex flex-col">
        ...
        <header class="w-full bg-white shadow-sm border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                <div class="flex items-center">
                    ...
                    <h1 class="text-2xl font-bold text-gray-800 tracking-tight">信息科技学习网站</h1>
                </div>
        ...
        <main class="flex-grow flex items-center justify-center p-4 sm:p-8">
            <div class="glass-panel rounded-2xl w-full max-w-md p-8 relative overflow-hidden transition-all duration-300 hover:shadow-xl">
                <!-- Decorative element -->
                <div class="absolute top-0 right-0 -mr-8 -mt-8 w-32 h-32 rounded-full bg-blue-100 opacity-50 pointer-events-none"></div>
                <div class="absolute bottom-0 left-0 -ml-8 -mb-8 w-24 h-24 rounded-full bg-green-100 opacity-50 pointer-events-none"></div>
                
                <div class="relative z-10">
                    <div class="text-center mb-8">
                        <h2 class="indexhead text-3xl font-extrabold text-gray-900 mb-2">登录窗口</h2>
                        <p class="text-sm text-gray-500">请输入您的学号和密码</p>
                    </div>

                    <div class="space-y-5">
                        <div>
                            <label for="TextBoxuser" class="block text-sm font-medium text-gray-700 mb-1">学号</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="TextBoxpwd" class="block text-sm font-medium text-gray-700 mb-1">密码</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <asp:TextBox ID="TextBoxpwd" runat="server"  
                                    TextMode="Password" EnableViewState="False" AutoCompleteType="Disabled" 
                                    CssClass="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors shadow-sm text-gray-900 placeholder-gray-400"
                        ...
                        <div class="text-center mt-2">
                            <asp:Label ID="Labelmsg" runat="server" SkinID="LabelMsgRed" CssClass="text-red-500 text-sm font-medium block h-5"></asp:Label>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <div class="grid grid-cols-3 gap-3">
                            <asp:HyperLink ID="HyperLinkReg" runat="server" 
                                NavigateUrl="~/student/register.aspx" Target="_self" 
                                CssClass="flex items-center justify-center px-2 py-2 border border-transparent text-xs font-medium rounded-md text-green-700 bg-green-100 hover:bg-green-200 transition-colors">
                                学员注册
                            </asp:HyperLink>
                            
                            <asp:HyperLink ID="HyperLinkSnum" runat="server" 
                                NavigateUrl="~/student/mynum.aspx" Target="_self" 
                                CssClass="flex items-center justify-center px-2 py-2 border border-transparent text-xs font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 transition-colors">
                                学号查询
                            </asp:HyperLink>
        ...
        <!-- Footer -->
        <footer class="w-full bg-white bg-opacity-80 backdrop-blur-md border-t border-gray-200 py-6 mt-auto">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 space-y-4 md:space-y-0">
                <div class="flex items-center space-x-4">
                    <asp:Label ID="Labelversion" runat="server"></asp:Label>
                    <asp:HyperLink ID="HLTeacher" runat="server" 
                        NavigateUrl="~/teacher/index.aspx" Target="_blank" 
                ...
                <div class="flex flex-wrap justify-center md:justify-end items-center gap-x-4 gap-y-2">
                    <span class="flex items-center">
                        <svg class="h-4 w-4 mr-1 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                        </svg>
                        IP: <asp:Label ID="Labelip" runat="server" CssClass="ml-1 font-mono"></asp:Label>
                    </span>
                    <span class="flex items-center">
                        <svg class="h-4 w-4 mr-1 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
                        </svg>
                        主机: <asp:Label ID="Labelhostname" runat="server" CssClass="ml-1 font-mono"></asp:Label>
                    </span>
                    <span class="flex items-center">
                        <svg class="h-4 w-4 mr-1 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                inputs.forEach(input => {
                    input.addEventListener('focus', function() {
                        this.parentElement.parentElement.classList.add('transform', '-translate-y-1', 'transition-transform', 'duration-200');
                    });
                    input.addEventListener('blur', function() {
                        this.parentElement.parentElement.classList.remove('transform', '-translate-y-1');
                    });
                });
            });
        </script>
