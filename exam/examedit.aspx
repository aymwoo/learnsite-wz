<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examedit.aspx.cs" Inherits="exam_examedit" MasterPageFile="~/teacher/Teach.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <style>
        ...
        .info-box { background: #fff7e6; border: 1px solid #ffd591; border-radius: 4px; padding: 10px; margin-bottom: 15px; }
        .info-box .title { font-weight: 600; color: #d46b08; margin-bottom: 5px; }
    </style>
