(function () {
            ...
            function getContentElement() {
                return document.getElementById(window.__missionshowConfig.mcontentId);
            }

            function getHiddenRawElement() {
                return document.getElementById(window.__missionshowConfig.hiddenMissionRawId);
            }

            function getMarkdownToggle() {
                return document.getElementById(window.__missionshowConfig.markdownToggleId);
            }

            function getMarkdownStatus() {
                return document.getElementById(window.__missionshowConfig.markdownToggleStatusId);
            }

            function getRevealToggle() {
                return document.getElementById(window.__missionshowConfig.revealToggleId);
            }

            function getRevealStatus() {
                return document.getElementById(window.__missionshowConfig.revealToggleStatusId);
            }
