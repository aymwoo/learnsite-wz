<%@ Page Language="C#" AutoEventWireup="true" CodeFile="idle.aspx.cs" Inherits="Python_idle" %>
...
<input id="title" type="text" value="未命名" class="idle-toolbar__title px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300" />
