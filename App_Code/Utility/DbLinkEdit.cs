...
namespace LearnSite.DBUtility
{
    ...
    public class DbLinkEdit
    {
       ...
       public static string serverNameFixnew()
       {
           string str = Common.Computer.GetServerName();
           string ver = Common.WordProcess.SysVerUpdate();
           return Common.WordProcess.GetMD5(str + ver);
       }
