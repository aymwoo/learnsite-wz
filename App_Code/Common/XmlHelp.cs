...
namespace LearnSite.Common
{
    ...
    public class XmlHelp
    {
        ...
        public static bool GetOfficePng()
        {
            string res = GetTypeName("OfficePng");
            if (res.Equals("0"))
                return false;
            else
                return bool.Parse(res);
        }
        public static bool GetHideName()
        {
            string res = GetTypeName("HideName");
            if (res.Equals("0"))
                return false;
            else
                return bool.Parse(res);
        ...
        {
            string oldorg = "www.learnsite.cn";
        ...
        /// <returns></returns>
        public static string xmlRead(string url)
        {
