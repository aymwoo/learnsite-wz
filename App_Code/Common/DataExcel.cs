...
namespace LearnSite.Common
{
    ...
    public class DataExcel
    {
        ...
        public static string Saveupexcel(FileUpload FileUpExcel)
        {
            if (FileUpExcel.HasFile)
            {
                ...
                if (exceltype.ToLower() == "xls")
                {
                    ...
                    string savepath =Flatform.Checkbdir(excelpath) + newexcel + "." + exceltype;
        ...
        {
            return LearnSite.Common.ExcelHelper.ExcelToDataSet(filepath, true);
        }
        /// <summary>
        /// 清空临时表
        /// </summary>
        ...
        /// </summary>
        /// <param name="upexcelpath"></param>
        public static string DataSetaddEnglish(int level)
        {
        ...
        public static string SaveIpExcel(FileUpload FileUpExcel)
        {
            ...
            if (exceltype == "xls")
            {
                ...
                string savepath = Common.Flatform.Checkbdir(excelpath) + newexcel + "." + exceltype;
                FileUpExcel.PostedFile.SaveAs(savepath);
                return savepath;
            }
            else
        ...
        public static string SavekaoxuExcel(FileUpload FileUpExcel)
        {
            ...
            if (exceltype == "xls")
            {
                ...
                string newfilename = Common.Flatform.Checkbdir(excelpath) + newexcel + "." + exceltype;
