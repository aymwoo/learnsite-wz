...
<div class="courseshow">
    ...
    <div class="courseother">
       日期：<asp:Label ID="LabelMdate"  runat="server" ></asp:Label>
            ...
            &nbsp;<asp:Image ID="Imgauto" runat="server" /><asp:HyperLink ID="HLauto" runat="server" CssClass="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition duration-300 shadow-md text-center inline-block">自动批改</asp:HyperLink>
            ...
            <asp:HyperLink ID="HlExample" runat="server" Target="_blank" CssClass="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition duration-300 shadow-md text-center inline-block">编程实例</asp:HyperLink>
            &nbsp;&nbsp; <asp:HyperLink 
