...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    <div class="w-full max-w-6xl mx-auto p-4 sm:p-6 space-y-6 font-sans text-slate-800">
        ...
        <div class="bg-slate-100 rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col lg:flex-row items-center justify-between gap-6 border-l-8 border-l-indigo-600">
            <div class="flex flex-col sm:flex-row items-center gap-4">
                <h1 class="text-2xl font-extrabold text-slate-900 flex items-center gap-2 whitespace-nowrap">
                    <i class="bi bi-people-fill text-indigo-700"></i> 学生管理
                </h1>
            ...
            <div class="flex items-center">
                <asp:HyperLink ID="HkaddStu" runat="server" CssClass="px-5 py-2.5 bg-indigo-600 text-white font-bold text-sm rounded-xl hover:bg-indigo-700 transition shadow-sm border-0 flex items-center gap-1.5 cursor-pointer">
        ...
        <!-- Data Grid -->
        <div class="bg-white shadow-sm border border-slate-200 overflow-x-auto rounded-xl w-full">
        ...
        <div class="flex flex-col gap-4">
            <!-- Quick Actions Bar -->
            <div class="bg-white p-4 shadow-sm border border-slate-200 flex flex-wrap items-center justify-between gap-4 rounded-xl">
            ...
            <div class="bg-slate-50 rounded-xl p-5 flex flex-wrap items-center gap-6 border border-slate-200 shadow-sm mt-2">
                <div class="flex items-center gap-3 pr-6 border-r border-slate-300">
