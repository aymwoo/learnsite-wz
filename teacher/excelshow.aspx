<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/Teach.master" AutoEventWireup="true" CodeFile="excelshow.aspx.cs" Inherits="teacher_excelshow" %>
...
<div class="courseshow">
   ...
   &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" 
            NavigateUrl="~/luckysheetbottle/index.html" Target="_blank" ToolTip="协作表格静态网址" CssClass="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition duration-300 shadow-md text-center inline-block">协作表格</asp:HyperLink>
   </div>
