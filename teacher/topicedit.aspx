    ...
    <textarea  id ="mcontent" runat ="server" style="width: 800px; height:500px;" ></textarea>  
     ...
     <div  class="placehold">
         ...
         <br />
              ...
              <asp:Button ID="BtnCourse" runat="server"  Text="主题返回" OnClick="BtnCourse_Click"  SkinID="BtnNormal"  CssClass="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300 shadow-md border-0" /><br />
         <br />
         </div>
