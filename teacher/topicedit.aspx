<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/Teach.master"  StylesheetTheme="Teacher" Validaterequest="false" AutoEventWireup="true" CodeFile="topicedit.aspx.cs" Inherits="Teacher_topicedit" ResponseEncoding="utf-8" %>
...
<div  class="cplace">
    <div  class="cleft">
        &nbsp;讨论主题：<asp:TextBox ID="Texttitle" runat="server"  SkinID="TextBoxNormal" 
            Width="400px"  CssClass="px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300"></asp:TextBox>
    ...
    <div  >
		...
		<script>
            ...
            function syncContent() {
                ...
                if (currentEditor === 'kindeditor' && editor) mcontent.value = editor.html();
    ...
    <div id="wangeditor-wrap" style="display:none; width: 800px; position:relative; border:1px solid #ccc; z-index:100; margin-bottom:10px;">
        <div id="wangeditor-toolbar" style="border-bottom:1px solid #ccc;"></div>
        <div id="wangeditor-text" style="height:400px;"></div>
    </div>
    <div id="vditor-wrap" style="display:none; width: 800px; position:relative; margin-bottom:10px;">
    ...
    <textarea  id ="mcontent" runat ="server" style="width: 800px; height:500px;" ></textarea>  
     ...
     <div  class="placehold">
         ...
         <br />
               <asp:Button ID="Btnedit" runat="server"  Text="修改主题" OnClick="Btnedit_Click" OnClientClick="return syncContent();"
                    CssClass="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300 shadow-md border-0" />&nbsp;&nbsp;&nbsp;
              <asp:Button ID="BtnCourse" runat="server"  Text="主题返回" OnClick="BtnCourse_Click" CssClass="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300 shadow-md border-0" /><br />
         <br />
         </div>
