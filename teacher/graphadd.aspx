...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <style type="text/css">
        ...
        .graph-add-editor-stage #wangeditor-wrap,
        .graph-add-editor-stage #vditor-wrap,
        .graph-add-editor-stage textarea,
        .graph-add-editor-stage .ke-container {
            width: 100% !important;
            max-width: 100%;
        }
    </style>
