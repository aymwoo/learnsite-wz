<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/Teach.master" StylesheetTheme="Teacher" Validaterequest="false"  AutoEventWireup="true" CodeFile="programedit.aspx.cs" Inherits="Teacher_programedit" ResponseEncoding="utf-8" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <style type="text/css">
        ...
        .program-edit-editor-stage #wangeditor-wrap,
        .program-edit-editor-stage #vditor-wrap,
        .program-edit-editor-stage textarea,
    ...
    <div class="content-add-page program-edit-page">
        <div class="content-add-shell is-medium">
            ...
            <section class="content-add-editor">
                ...
                <div class="program-edit-editor-wrap">
                    ...
                    <div>
                        ...
                        <select id="editorSelector" onchange="switchEditor(this.value)" class="program-edit-editor-select">
