        ...
        if (e.Row.RowIndex > -1)
        {
            ...
            if (lb.Text != "")
            {
                ...
                if (LearnSite.Common.CookieHelp.IsTeacher())
                    hlview.NavigateUrl = "~/student/download.aspx?id=" + LearnSite.Common.EnDeCode.Encrypt(view, "ls");
                else
                    hlview.NavigateUrl = "#";
                ...
                if (Request.QueryString["Stat"] == null)
                {
                    ...
                    {
                        hl.NavigateUrl = "~/student/download.aspx?id=" + LearnSite.Common.EnDeCode.Encrypt(view, "ls");
                    }
                    else
                    {
