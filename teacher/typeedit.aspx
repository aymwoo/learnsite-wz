...
<br />
    <div  class="typedivhead">
        &nbsp; 文章标题：<asp:TextBox ID="Ttitle" runat="server"  Width="200px"  SkinID="TextBoxNormal" CssClass="px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300"></asp:TextBox>
    ...
    <div  class="typediv">
     ...
     <div  class="typedivcenter">
         <br />
              <asp:Button ID="BtnEdit" runat="server" Text="修改" OnClick="BtnEdit_Click" SkinID="BtnNormal"   CssClass="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300 shadow-md border-0" />&nbsp;&nbsp;&nbsp;
