...
(function (w, i) {
    ...
    function m(a, b) {
        if (Z(a))
            ...
            for (c in a)
                if (a.hasOwnProperty(c) && b.call(a[c], c, a[c]) === !1)
                    break
    }
    function B(a) {
        return a.replace(/(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g,
    ...
    function u(a, b) {
        ...
        m(d, function (a, b) {
            if (e = /^(\d+)\.\.(\d+)$/.exec(b))
                for (var d = parseInt(e[1], 10); d <= parseInt(e[2], 10); d++)
                    c[d.toString()] = !0;
            else
                c[b] = !0
        });
    ...
    function ia(a, b, c, d) {
        ...
        if (J(b, ["absolute", "relative", "domain"]) < 0)
            return a;
        c = c || location.protocol + "//" + location.host;
        if (d === i)
            var h = location.pathname.match(/^(\/.*)\//), d = h ? h[1] : "";
        var f;
        if (f = /^(\w+:\/\/[^\/]*)/.exec(a)) {
            if (f[1] !== c)
                return a
        ...
        a = a.replace(/(\s*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>(\s*)/g,
                ...
                if (mb[l] && !La[l])
                    if (d) {
                        ...
                        i = n = "\n";
                        K = 0;
                        for (ja = q ? f.length : f.length - 1; K < ja; K++)
                            n += e, q || (i += e);
                        r ? f.pop() : q || (i += e)
                    } else
                        n = i = "";
    ...
    function Ca(a, b) {
        ...
        function g(a, b, c) {
            ...
            if (c.getElementsByClassName) {
                ...
                for (f = e.length; h < f; h++)
                    j = e[h], d(b, j.nodeName) && g.push(j)
            } else if (e.querySelectorAll) {
                e = e.querySelectorAll((c.nodeName !== "#document" ? c.nodeName + " " : "") + b + "." +
                        a);
                h = 0;
                for (f = e.length; h < f; h++)
                    j = e[h], Aa(c, j) && g.push(j)
            } else {
                e = c.getElementsByTagName(b);
                a = " " + a + " ";
                h = 0;
                for (f = e.length; h < f; h++)
                    if (j = e[h], j.nodeType == 1)
                        (b = j.className) && (" " + b + " ").indexOf(a) > -1 && g.push(j)
            }
            return g
        }
        function h(a, b, d, e) {
            for (var g = [], d = e.getElementsByTagName(d), h = 0, f = d.length; h < f; h++)
                e = d[h], e.nodeType == 1 && (b === null ? Ba(e, a) !== null && g.push(e) : b === c(Ba(e, a)) && g.push(e));
            return g
        }
        function f(a, b) {
            var c = [],
            ...
            if (j = /#((?:[\w\-]|\\.)+)$/.exec(a))
                ...
                if (c === "id")
                    ...
                    for (var n, r = 0, q = j.length; r < q; r++)
                        n = j[r], d(k, n.nodeName) && Aa(b, n) && n.getAttribute("name") !== null && c.push(n);
                    k = c
                } else
                    k =
                        h(c, j, k, b);
        ...
        for (var b = b || document, k = [], q, r = /((?:\\.|[^\s>])+|[\s>])/g; q = r.exec(a); )
            q[1] !== " " && k.push(q[1]);
        q = [];
        if (k.length == 1)
            return f(k[0], b);
            ...
            if (K = k[z], K === ">")
                ...
                if (z > 0) {
                    ...
                    for (s = q.length; L < s; L++) {
                        ...
                        i = f(K, o);
                        F = 0;
                        for (t = i.length; F < t; F++)
                            p = i[F], r ? o === p.parentNode && l.push(p) : l.push(p)
                    }
                    q = l
                } else
                    q = f(K, b);
    ...
    function Qa(a, b, c) {
        ...
        function g(e, l) {
            for (var i = e.firstChild, o; i; ) {
                ...
                if (n > 0)
                    if (i.nodeType == 1)
                        if (q >= 0 && r <= 0)
                            b && l.appendChild(i.cloneNode(!0)), c && f.push(i);
                        else {
                            var p;
                    ...
                    else if (i.nodeType == 3 && (i = i == k.startContainer ? d(i, k.startOffset, i.nodeValue.length) : i == k.endContainer ? d(i, 0, k.endOffset) : d(i, 0, i.nodeValue.length), b))
                        try {
                            l.appendChild(i)
                        } catch (ja) {}
                i = o
        ...
        if (l.nodeType == 3)
            return l = d(l, a.startOffset, a.endOffset), b && i.appendChild(l), e(), b ? i : a;
        g(l, i);
        c && a.up().collapse(!0);
    ...
    function na(a, b) {
        for (var c = b; c; ) {
            var d = f(c);
            if (d.name == "marquee" || d.name == "select")
                return;
            c = c.parentNode
        }
        try {
    ...
    function sb(a, b) {
        ...
        for (var q = 0, r = g.length; q < r; q++) {
            ...
            if (i.nodeType ==
                ...
                i.nodeType == 3 && (n.moveStart("character", i.nodeValue.length), j += i.nodeValue.length);
            k < 0 && (h = i)
        }
        if (k < 0 && h.nodeType == 1)
            return {
        ...
        if (k > 0)
            for (; h.nextSibling && h.nodeType == 1; )
                h = h.nextSibling;
        n = a.duplicate();
        na(n, e);
        ...
        j -= n.text.replace(/\r\n|\n|\r/g, "").length;
        if (k > 0 && h.nodeType == 3)
            for (c = h.previousSibling; c && c.nodeType == 3; )
                j -= c.nodeValue.length, c = c.previousSibling;
        return {
            node: h,
            offset: j
        }
    ...
    function tb(a, b) {
        ...
        if (a.nodeType == 1 && a.childNodes.length > 0) {
            ...
            if (!g)
                return d;
            if (f(g).name === "head")
                return b === 1 && (e = !0), b === 2 && (e = !1), d.collapse(e), d;
            if (g.nodeType == 1) {
                var h = f(g),
                j;
                h.isControl() &&
    ...
    function ub(a) {
        ...
        if (H) {
            if (a.item)
                return c = V(a.item(0)), c = new M(c), c.selectNode(a.item(0)), c;
    ...
    function $b(a, b, c, d) {
        var e = [Za === "" ? "<html>" : '<html dir="' + Za + '">', '<head><meta charset="utf-8" /><title></title>', "<style>", "html {margin:0;padding:0;}", "body {margin:0;padding:5px;}", 'body, td {font:16px/1.5 "sans serif",tahoma,verdana,helvetica;}', "body, p, div {word-wrap: break-word;}", "p {margin:5px 0;}", "table {border-collapse:collapse;}", "img {border:0;}", "noscript {display:none;}", "table.ke-zeroborder td {border:1px dotted #AAA;}",
    ...
    function Ea(a, b) {
        if (!a.collapsed) {
            ...
            d = a.startOffset;
            if (X || a.isControl())
                if ((c = f(c.childNodes[d])) && c.name == "img" && b(c))
                    return c
        }
    }
    function ac() {
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    ...
                    for (m(a._contextmenus, function () {
                            if (this.title == "-")
                                d.push(this);
                                else if (this.cond && this.cond() && (d.push(this), this.width && this.width > c))
                                    c = this.width
                            }); d.length > 0 && d[0].title == "-"; )d.shift();
                    for (; d.length > 0 && d[d.length - 1].title == "-"; )
                        d.pop();
                    var e = null;
                    m(d, function (a) {
    ...
    function cc() {
        ...
        f(b).keydown(function (c) {
            if (c.which == 9)
                if (c.preventDefault(), a.afterTab)
                    a.afterTab.call(a, c);
                else {
                    var c = a.cmd,
                    d = c.range;
    ...
    function ua(a) {
        ...
        if (!c.width)
            c.width = d[0].style.width || d.width();
        if (!c.height)
            c.height = d[0].style.height || d.height();
    ...
    if (!w.KindEditor) {
        ...
        f.basePath = function () {
            for (var a =
                ...
                if (b = a[c].src || "", /kindeditor[\w\-\.]*\.js/.test(b))
        ...
        f.options = {
            ...
            minChangeSize: 50,
            zIndex: 811213,
            items: ["source", "|", "undo", "redo", "|", "template", "code", "nature", "|", "cut", "copy", "paste", "plainpaste", "wordpaste", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "insertorderedlist", "insertunorderedlist", "indent", "outdent", "subscript", "superscript", "clearhtml", "anchor", 'quickformat', "selectall", "fullscreen", "/", "formatblock",
                "fontname", "fontsize", "|", "forecolor", "hilitecolor", "bold", "italic", "underline", "strikethrough", "hr", "removeformat", "|", "image", "flash", "flv", "scratch", "freemind", "insertfile", "|", "table", "emoticons", "baidumap", "link", "unlink", "about", "word"],
        ...
        E(gb, {
            init: function (a, b) {
                ...
                if (!c.which && (c.charCode || c.charCode ===
                        0 ? c.charCode : c.keyCode))
                    c.which = c.charCode || c.keyCode;
                if (!c.metaKey && c.ctrlKey)
                    c.metaKey = c.ctrlKey;
                if (!c.which && c.button !== i)
        ...
        f.ready = function (a) {
            ...
            if (Pb)
                ...
                if (document.addEventListener)
                    aa(document, "DOMContentLoaded", b);
        ...
        E(D, {
            init: function (a) {
                for (var a = Z(a) ? a : [a], b = 0, c = 0, d = a.length; c < d; c++)
                    a[c] && (this[c] = a[c].constructor ===
                            D ? a[c][0] : a[c], b++);
                this.length = b;
                this.doc = V(this[0]);
                this.name = Oa(this[0]);
            ...
            attr: function (a, b) {
                ...
                if (b === i)
                    return b = c.length < 1 ? null : Ba(c[0], a), b === null ? "" : b;
                c.each(function () {
                    Na(this, a, b)
                });
                return c
            ...
            addClass: function (a) {
                this.each(function () {
                    if (!xa(a, this.className, " "))
                        this.className = B(this.className + " " + a)
                });
                return this
            },
            removeClass: function (a) {
                this.each(function () {
                    if (xa(a, this.className, " "))
                        this.className = B(this.className.replace(RegExp("(^|\\s)" + a + "(\\s|$)"), " "))
                });
                return this
            },
            html: function (a) {
            ...
            pos: function () {
                ...
                if (a)
                    if (a.getBoundingClientRect)
                        a = a.getBoundingClientRect(), c = ca(this.doc), b = a.left + c.x, c = a.top + c.y;
                    else
                        for (; a; )
            ...
            children: function () {
                ...
                for (var a = [], b = this[0].firstChild; b; )
                    (b.nodeType != 3 || B(b.nodeValue) !== "") && a.push(b), b = b.nextSibling;
                return new D(a)
            },
            first: function () {
                var a = this.children();
            ...
            scan: function (a, b) {
                ...
                if (!(this.length < 1))
                    return b = b === i ? !0 : b, c(this[0]), this
            }
        });
        ...
        E(M, {
            ...
            setStart: function (a, b) {
                ...
                this.startContainer = a;
                this.startOffset = b;
                if (this.endContainer === c)
                    this.endContainer = a, this.endOffset = b;
                return rb(this)
            },
            setEnd: function (a, b) {
                var c = this.doc;
                this.endContainer = a;
                this.endOffset = b;
                if (this.startContainer === c)
                    this.startContainer = a, this.startOffset = b;
                return rb(this)
            },
            ...
            selectNodeContents: function (a) {
                var b = f(a);
                if (b.type == 3 || b.isSingle())
                    return this.selectNode(a);
                b = b.children();
                if (b.length > 0)
                    return this.setStartBefore(b[0]).setEndAfter(b[b.length -
                            1]);
            ...
            compareBoundaryPoints: function (a, b) {
                ...
                if (H) {
                    ...
                    if (g === h)
                        return g = j - k, g > 0 ? 1 : g < 0 ? -1 : 0;
                    for (c = h; c && c.parentNode !== g; )
                        c = c.parentNode;
                    if (c)
                        return f(c).index() >= j ? -1 : 1;
                    for (c = g; c && c.parentNode !== h; )
                        c = c.parentNode;
                    if (c)
                        return f(c).index() >= k ? 1 : -1;
                    if ((c = f(h).next()) && c.contains(g))
                        return 1;
                    if ((c = f(g).next()) && c.contains(h))
                        return -1
                } else
                    return c.compareBoundaryPoints(a, d)
            },
            cloneRange: function () {
            ...
            insertNode: function (a) {
                ...
                if (a.nodeName.toLowerCase() === "#document-fragment")
                    g = a.firstChild, f = a.lastChild, k = a.childNodes.length;
                ...
                if (this.compareBoundaryPoints(da, this.cloneRange().setEnd(d, e)) >= 1)
                    return this;
            ...
            get: function (a) {
                ...
                if (a && this.isControl())
                    return b = b.body.createControlRange(), b.addElement(this.startContainer.childNodes[this.startOffset]),
                    b;
            ...
            shrink: function () {
                for (var a, b = this.collapsed; this.startContainer.nodeType == 1 && (a = this.startContainer.childNodes[this.startOffset]) && a.nodeType == 1 && !f(a).isSingle(); )
                    this.setStart(a, 0);
                if (b)
                    return this.collapse(b);
                for (; this.endContainer.nodeType == 1 && this.endOffset > 0 && (a = this.endContainer.childNodes[this.endOffset - 1]) && a.nodeType == 1 && !f(a).isSingle(); )
            ...
            createBookmark: function (a) {
                ...
                if (!this.collapsed)
                    b = c.cloneNode(!0), b.id = "__kindeditor_bookmark_end_" + Qb++ + "__";
        ...
        E(oa, {
            ...
            selection: function (a) {
                ...
                this.sel = Sa(b);
                if (c)
                    return this.range = Ra(c), f(this.range.startContainer).name == "html" && this.range.selectNodeContents(b.body).collapse(!1),
                    this;
            ...
            select: function (a) {
                ...
                if (a && d.nodeType == 1 && c.collapsed) {
                    ...
                    if (X && (a = d.childNodes, f(d).isInline() || e > 0 && f(a[e - 1]).isInline() || a[e] && f(a[e]).isInline()))
                        c.insertNode(g.createTextNode("\u200b")),
                        k = !0
                }
                if (H)
                    try {
                    ...
                    k && c.collapse(!1), j = c.get(!0), b.removeAllRanges(), b.addRange(j), g !== document && (c = f(j.endContainer).pos(), h.scrollTo(c.x, c.y));
                h.focus();
                return this
            },
            wrap: function (a) {
                ...
                c = f(a, this.doc);
                if (b.collapsed)
                    return b.shrink(), b.insertNode(c[0]).selectNodeContents(c[0]), this;
                if (c.isBlock()) {
                    for (var d = a = c.clone(!0); d.first(); )
                        d = d.first();
                ...
                f(a).scan(function (a) {
                    if (!g && a == e.start)
                        ...
                        if (!d && b.type == 3 && B(a.nodeValue).length > 0) {
                            for (var n; (n = b.parent()) && n.isStyle() && n.children().length == 1; )
                                b = n;
                            n = c;
                            n = n.clone(!0);
                            if (b.type == 3)
                                Va(n).append(b.clone(!1)), b.replaceWith(n);
                            else {
                                for (var a = b, i; (i = b.first()) && i.children().length == 1; )
                                    b = i;
                                i = b.first();
                                for (b = b.doc.createDocumentFragment(); i; )
                                    b.appendChild(i[0]),
                                    i = i.next();
                                i = a.clone(!0);
                                d = Va(i);
                                for (var r = i, l = !1; n; ) {
                                    for (; r; )
                                        r.name === n.name && (Zb(r, n.attr(), n.css()), l = !0), r = r.first();
            ...
            remove: function (a) {
                ...
                c.enlarge();
                if (c.startOffset === 0) {
                    for (var d = f(c.startContainer), e; (e = d.parent()) && e.isStyle() && e.children().length == 1; )
                        d = e;
                    c.setStart(d[0], 0);
                ...
                if (c.collapsed) {
                    ...
                    b = c.startContainer;
                    d = c.startOffset;
                    if (d > 0 && (e = f(b.childNodes[d - 1])) && ea(e))
                        e.remove(), c.setStart(b, d - 1);
                ...
                if (d > 0) {
                    ...
                    i && ea(i) && (i.remove(), c.setStart(b, d - 1), b == e && c.setEnd(e,
                            n - 1));
                    if ((d = f(b.childNodes[d])) && ea(d))
                        d.remove(), b == e && c.setEnd(e, n - 1)
                }
            ...
            val: function (a) {
                ...
                if (a === "fontfamily" || a === "fontname")
                    return c = vb(b, "fontname"), c = c.replace(/['"]/g, ""), c.toLowerCase();
                if (a === "formatblock") {
                    c = vb(b, a);
            ...
            createlink: function (a, b) {
                ...
                b && (g += ' target="' + C(b) + '"');
                if (e.collapsed)
                    return g += ">" + C(a) + "</a>", this.inserthtml(g);
                if (e.isControl()) {
                ...
                j = e.endContainer,
                e = e.endOffset;
                if (g.nodeType == 1 && g === j && h + 1 === e && (e = g.childNodes[h], e.nodeName.toLowerCase() == "a"))
                    return c(e, a, b), this;
        ...
        m("cut,copy,paste".split(","), function (a, b) {
            oa.prototype[b] = function () {
                if (!this.doc.queryCommandSupported(b))
                    throw "not supported";
                this.select();
                Q(this.doc, b, null);
                return this
        ...
        E(S, {
            ...
            pos: function (a, b, c) {
                c = l(c, !0);
                if (a !== null && (a = a < 0 ? 0 : s(a), this.div.css("left", a), c))
                    this.x = a;
                if (b !== null && (b = b < 0 ? 0 : s(b), this.div.css("top", b), c))
                    this.y = b;
                return this
            },
            autoPos: function (a, b) {
                ...
                if (this._alignEl) {
                    ...
                    h = G(this.doc), x = R(e.x + (h.clientWidth - c) / 2), y = R(e.y + (h.clientHeight - d) / 2);
                o && A < 7 || P || (x -= e.x, y -= e.y);
                return this.pos(x, y)
            },
            remove: function () {
        ...
        f.widget = Ya;
        var Za = "";
        if (p = document.getElementsByTagName("html"))
            Za = p[0].dir;
        E(qa, S, {
            init: function (a) {
                function b() {
            ...
            html: function (a, b) {
                ...
                if (this.designMode) {
                    c = c.body;
                    if (a === i)
                        return a = b ? "<!doctype html><html>" + c.parentNode.innerHTML + "</html>" : c.innerHTML, this.beforeGetHtml && (a = this.beforeGetHtml(a)), Y && a == "<br />" && (a = ""), a;
            ...
            design: function (a) {
                if (a === i ? !this.designMode : a) {
                    if (!this.designMode)
                        a = this.html(), this.designMode = !0, this.html(a), this.textarea.hide(), this.iframe.show()
                } else if (this.designMode)
                    a = this.html(), this.designMode = !1, this.html(a), this.iframe.hide(), this.textarea.show();
                return this.focus()
            },
            focus: function () {
        ...
        E(Da, S, {
            init: function (a) {
                ...
                function c(a, c) {
                    var d = b(a.target);
                    if (d && !d.hasClass("ke-disabled") && !d.hasClass("ke-selected"))
                        d[c]("ke-on")
                }
                var d = this;
            ...
            enable: function (a) {
                if (a = a.get ? a : this.get(a))
                    a.removeClass("ke-disabled"), a.opacity(1);
                return this
            },
            disable: function (a) {
                if (a = a.get ? a : this.get(a))
                    a.removeClass("ke-selected").addClass("ke-disabled"), a.opacity(0.5);
                return this
            },
        ...
        E(sa, S, {
            init: function (a) {
                ...
                for (var e = 0; e < b.length; e++)
                    for (var c = a.insertRow(e + 1), g = 0; g < b[e].length; g++)
                        d = c.insertCell(g), this._addAttr(d, b[e][g], "ke-colorpicker-cell")
            },
        ...
        E(ab, {
            init: function (a) {
                ...
                i;
                for (i in g)
                    k.push('<input type="hidden" name="' + i + '" value="' + g[i] + '" />');
        ...
        ua.prototype = {
            ...
            create: function () {
                ...
                if (b.isCreated)
                    return b;
                if (b.srcElement.data("kindeditor"))
                    return b;
                ...
                if (c) {
                    ...
                    b._fullscreenExecuted && (f(document.body).css({
                            height: "",
                            overflow: ""
                ...
                if (b._fullscreenResizeHandler)
                    f(w).unbind("resize", b._fullscreenResizeHandler), b._fullscreenResizeHandler = null;
                a();
            ...
            resize: function (a, b, c) {
                ...
                if (a && (/%/.test(a) || (a = t(a), a = a < this.minWidth ? this.minWidth : a), this.container.css("width", s(a)),
                        c))
                    this.width = s(a);
                if (b && (b = t(b), editHeight = t(b) - this.toolbar.div.height() - this.statusbar.height(), editHeight = editHeight < this.minHeight ? this.minHeight : editHeight, this.edit.setHeight(editHeight), c))
                    this.height = s(b);
                return this
            },
            select: function () {
            ...
            html: function (a) {
                if (a === i)
                    return this.isCreated ? this.edit.html() : pa(this.srcElement);
            ...
            appendHtml: function (a) {
                ...
                if (this.isCreated)
                    a = this.cmd, a.range.selectNodeContents(a.doc.body).collapse(!1), a.select();
                return this
            },
            sync: function () {
                pa(this.srcElement, this.html());
            ...
            addBookmark: function (a) {
                ...
                if (a && this._undoStack.length >
                    0 && Math.abs(d.length - T(this._undoStack[this._undoStack.length - 1].html).length) < this.minChangeSize)
                    return this;
                ...
                a(d.body).bind("paste", function (p) {
                    if (b.pasteType === 0)
                        ...
                        if (o) {
                            ...
                            f.range.selectNodeContents(i[0]), f.select();
                        setTimeout(function () {
                            c();
                            m = !1
                        }, 0)
